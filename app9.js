...
<div style="margin-top: 20px" class="mdui-center mdui-text-center">
 <a href="#" target="_blank">
        <img src="https://raw.githubusercontent.com/ItsIsmailRobin/revflix/main/revflix.png" alt="RevFLIX">
      </a>
  ...
  if (UI.credits) {
    ...
    <div style="margin-bottom: 20px" class="mdui-center mdui-text-center">
      <a href="https://github.com/ItsIsmailRobin/" target="_blank">
        <img src="https://img.shields.io/static/v1?label=ItsIsmailRobin&amp;message=Project-RevFLIX-Extended&amp;color=831ef2&amp;labelColor=2b3037&amp;logo=github" alt="cheems - goindex-extended">
      </a>
    </div>
    </div>
    `
